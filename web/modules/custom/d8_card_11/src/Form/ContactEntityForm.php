...
class ContactEntityForm extends ContentEntityForm {
  ...
  /**
   * Constructs a new ContactEntityForm.
   *
  ...
  public function save(array $form, FormStateInterface $form_state) {
    ...
    switch ($status) {
      case SAVED_NEW:
        $this->messenger()->addMessage($this->t('Created the %label Contact entity.', [
          '%label' => $entity->label(),
        ]));
        break;

      default:
        $this->messenger()->addMessage($this->t('Saved the %label Contact entity.', [
          '%label' => $entity->label(),
        ]));
    }
