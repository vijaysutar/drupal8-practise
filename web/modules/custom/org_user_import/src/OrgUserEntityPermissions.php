...
use Drupal\org_user_import\Entity\OrgUserEntityType;


/**
 * Provides dynamic permissions for Org user entity of different types.
 *
 * @ingroup org_user_import
 *
 */
class OrgUserEntityPermissions{
   ...
   *
   * @return array
   *   The OrgUserEntity by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (OrgUserEntityType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\org_user_import\Entity\OrgUserEntityType $type
   *   The OrgUserEntity type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(OrgUserEntityType $type) {
    $type_id = $type->id();
